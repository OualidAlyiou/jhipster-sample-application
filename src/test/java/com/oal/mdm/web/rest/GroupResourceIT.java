...
import com.oal.mdm.IntegrationTest;
...
class GroupResourceIT {
  ...
  public static Group createEntity(EntityManager em) {
    Group group = new Group().name(DEFAULT_NAME).isDefault(DEFAULT_IS_DEFAULT);
    return group;
  }
  ...
  public static Group createUpdatedEntity(EntityManager em) {
    Group group = new Group().name(UPDATED_NAME).isDefault(UPDATED_IS_DEFAULT);
    return group;
  }
  ...
  void createGroup() throws Exception {
    ...
    assertThat(testGroup.getIsDefault()).isEqualTo(DEFAULT_IS_DEFAULT);
  }
  ...
  void getGroup() throws Exception {
    ...
    restGroupMockMvc
      ...
      .andExpect(
        jsonPath("$.isDefault").value(DEFAULT_IS_DEFAULT.booleanValue())
      );
  }
  ...
  void putNewGroup() throws Exception {
    ...
    updatedGroup.name(UPDATED_NAME).isDefault(UPDATED_IS_DEFAULT);
    ...
    assertThat(testGroup.getIsDefault()).isEqualTo(UPDATED_IS_DEFAULT);
  }
  ...
  void fullUpdateGroupWithPatch() throws Exception {
    ...
    partialUpdatedGroup.name(UPDATED_NAME).isDefault(UPDATED_IS_DEFAULT);
  ...
  void deleteGroup() throws Exception {
    ...
    restGroupMockMvc
      .perform(
        delete(ENTITY_API_URL_ID, group.getId())
